...
final Map<String, SceneConfig> sceneConfigs = {
  ...
  'j_1_1_1': SceneConfig(
    ...
    hotspots: const [
      SceneHotspot(
        ...
        label: 'The Ka\'bah',
        labelAr: 'الكعبة',
        fragment: 'The Ka\'bah stands, built by Ibrahim (peace be upon him) and his son Ismail (peace be upon him) as a house of the One God. That memory lingers in the stones, even as 360 idols press against them from every side. Something is coming. You can feel it in the desert wind.',
        ...
        didYouKnow: 'The Ka\'bah was originally built by Ibrahim (peace be upon him) and his son Ismail (peace be upon him) as a house of pure monotheism, with no roof, open to the sky.',
        didYouKnowAr: 'الكعبة بناها إبراهيم عليه السلام وابنه إسماعيل عليه السلام أصلاً بيتاً للتوحيد الخالص بلا سقف ومفتوحة على السماء.',
      ),
      SceneHotspot(
        id: 'idols',
        x: 0.25, y: 0.45,
  ...
  'j_1_1_2': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(
        ...
        didYouKnow: 'Abd al-Muttalib had once vowed to sacrifice one of his ten sons if Allah granted him that many. When the lots fell on Abdullah, the Prophet\'s father, the elders of Quraysh intervened and a ransom of one hundred camels was offered instead. This amount later became the standard blood money in Islam.',
        didYouKnowAr: 'كان عبد المطلب قد نذر أن يذبح أحد أبنائه إن رزقه الله عشرة. فلما وقعت القرعة على عبد الله والد النبي \uFDFA تدخّل أشراف قريش وفُدي بمئة من الإبل. وأصبح هذا العدد لاحقاً مقدار الدية في الإسلام.',
      ),
      SceneHotspot(
        id: 'elephants',
        x: 0.22, y: 0.42,
  ...
  'j_1_1_3': SceneConfig(
    ...
    hotspots: const [
      SceneHotspot(
        ...
        fragmentAr: 'جاءت الأمطار دون سابق إنذار سيلاً جارفاً اجتاح الوادي وضرب البيت العتيق فانهارت الجدران وتزحزحت الحجارة والكعبة المتهالكة بفعل القرون لم تعد تحتمل. اتفقت قبائل قريش على أنها يجب أن تُبنى من جديد فتراقب الرجال يحملون الحجارة من الوادي ويرصّونها بعناية والعمل بطيء لكنه موحّد في الوقت الحالي.',
        ...
        didYouKnowAr: 'أُعيد بناء الكعبة عدة مرات عبر التاريخ وإعادة البناء هذه على يد قريش حدثت حين كان محمد \uFDFA في الخامسة والثلاثين أي قبل النبوة بخمس سنوات فقط.',
      ),
      SceneHotspot(
        id: 'dispute',
        x: 0.25, y: 0.42,
        ...
        fragmentAr: 'الجدران شبه مكتملة لكن مهمة واحدة بقيت وهي إعادة الحجر الأسود إلى ركنه المقدس ومعها جاءت الأزمة. كل قبيلة تطالب بهذا الشرف والأيدي تقبض على مقابض السيوف والأصوات تعلو. أربعة أيام من الخلاف ولا حل والحرم المخصص للسلام يرتجف على حافة سفك الدماء.',
      ...
      SceneHotspot(
        ...
        fragmentAr: 'عند الفجر يُفتح باب الحرم وأول من يدخل هو محمد \uFDFA في الخامسة والثلاثين من عمره تعرفه كل القبائل لكنه لا ينتمي لأي فريق. همسة تسري في الجمع: "الأمين." لا أحد يعترض فقد ائتمنوه قبل النبوة بسنين ووجوده في تلك اللحظة ليس صدفة.',
        ...
        didYouKnow: 'The dispute over the Black Stone lasted four or five days. Some accounts report the tribes were so close to fighting that they dipped their hands in a bowl of blood to seal their readiness for war. Abu Umayyah\'s proposal to accept the first entrant at dawn was a last resort to prevent bloodshed in the sacred precinct.',
        didYouKnowAr: 'استمر الخلاف على الحجر الأسود أربعة أو خمسة أيام. وتذكر بعض الروايات أن القبائل كانت قريبة جداً من القتال حتى إنهم غمسوا أيديهم في طست من الدم إعلاناً لاستعدادهم للحرب. وكان اقتراح أبي أمية بقبول أول داخل عند الفجر الملاذ الأخير لمنع سفك الدماء في الحرم.',
      ),
      SceneHotspot(
        id: 'cloak',
        x: 0.50, y: 0.28,
  ...
  'j_1_2_1': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(
        ...
        didYouKnow: 'The Prophet \uFDFA was born on a Monday, the 12th of Rabi\' al-Awwal. His grandfather Abd al-Muttalib carried him to the Ka\'bah on the seventh day to present him before the ancient house, following the tradition of Quraysh for their newborns.',
        didYouKnowAr: 'وُلد النبي \uFDFA يوم الاثنين الثاني عشر من ربيع الأول. وحمله جدّه عبد المطلب إلى الكعبة في اليوم السابع ليقدّمه أمام البيت العتيق، اتباعاً لتقاليد قريش مع مواليدها.',
      ),
      SceneHotspot(
        id: 'naming_kaabah',
        x: 0.72, y: 0.42,
  ...
  'j_m1_007': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'second_loss', x: 0.50, y: 0.25, icon: '🕊️', label: 'The Second Loss', labelAr: 'الخسارة الثانية',
        ...
        didYouKnow: 'Abd al-Muttalib was approximately eighty-two years old when he died. Despite having many surviving sons, his final act was to entrust this one orphan grandson specifically to Abu Talib, choosing love and character over wealth and power.',
        didYouKnowAr: 'كان عبد المطلب في نحو الثانية والثمانين حين توفي. ورغم أن له أبناءً كثيرين أحياءً فإن آخر قراراته كانت أن يعهد بهذا الحفيد اليتيم تحديداً إلى أبي طالب، مختاراً الحب والخُلق على الغنى والسلطة.'),
  ...
  'j_1_2_3': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'road_north', x: 0.42, y: 0.46, icon: '🐪', label: 'The Road North', labelAr: 'الطريق شمالاً',
        ...
        didYouKnow: 'Abu Talib had many children of his own and was not a wealthy man. Yet he shielded his nephew from every hardship and took him on this long trade journey at his own expense, placing the boy between himself and the sun at every rest stop.',
        didYouKnowAr: 'كان لأبي طالب أبناء كثيرون ولم يكن رجلاً ثرياً. ومع ذلك حمى ابن أخيه من كل مشقة وأخذه في هذه الرحلة التجارية الطويلة على نفقته، يضع الصبي بينه وبين الشمس في كل استراحة.'),
  ...
  'j_1_2_4': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'ibn_judan', x: 0.25, y: 0.42, icon: '🏛️', label: 'House of Ibn Jud\'an', labelAr: 'دار ابن جدعان',
        ...
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Ibn Hisham | Al-Raheeq Al-Makhtum, Ch. 6', sourceRefAr: 'ابن هشام | الرحيق المختوم، الفصل 6',
        didYouKnow: 'The name "Hilf al-Fudul" means "The Pact of the Virtuous." It was named after an older pact from generations before, also called Hilf al-Fudul, where three men named al-Fadl joined together to defend the oppressed. The new pact carried the old name because it carried the same spirit.',
        didYouKnowAr: 'اسم "حلف الفضول" يعني عهد أصحاب الفضل، وقد سُمّي على اسم حلف قديم من أجيال سابقة حمل الاسم نفسه حين اجتمع ثلاثة رجال يحملون اسم الفضل للدفاع عن المظلومين، والحلف الجديد حمل الاسم القديم لأنه حمل الروح نفسها.'),
      ...
      SceneHotspot(id: 'pact_forever', x: 0.50, y: 0.25, icon: '💬', label: 'A Pact That Never Expired', labelAr: 'حلف لم تنتهِ صلاحيته',
        ...
        didYouKnow: 'The pact united the tribes of Hashim, Zuhra, and Taym in the house of Abdullah ibn Jud\'an, one of the wealthiest men in Mecca. It was one of the rare moments when competing clans set aside tribal loyalty for a principle greater than blood.',
        didYouKnowAr: 'جمع الحلف قبائل هاشم وزهرة وتيم في دار عبد الله بن جدعان أحد أغنى رجال مكة. وكانت واحدة من اللحظات النادرة التي تنحّت فيها العصبية القبلية أمام مبدأ أكبر من رابطة الدم.'),
    ],
  ...
  'j_m1_010': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'keeper_trusts', x: 0.25, y: 0.44, icon: '🔒', label: 'Keeper of Trusts', labelAr: 'حافظ الأمانات',
        ...
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Ibn Hisham | Al-Raheeq Al-Makhtum, Ch. 6', sourceRefAr: 'ابن هشام | الرحيق المختوم، الفصل 6',
        didYouKnow: 'When the Prophet \uFDFA migrated to Medina, he asked Ali ibn Abi Talib (may Allah be pleased with him) to stay behind in Mecca specifically to return the trusts that people had deposited with him. Even as they plotted to kill him, their belongings were still safe in his home.',
        didYouKnowAr: 'حين هاجر النبي \uFDFA إلى المدينة طلب من عليّ بن أبي طالب رضي الله عنه أن يبقى في مكة خصيصاً لإعادة الأمانات التي أودعها الناس عنده، فحتى وهم يتآمرون لقتله كانت ممتلكاتهم لا تزال آمنة في بيته.'),
      ...
      SceneHotspot(id: 'foundation', x: 0.50, y: 0.28, icon: '🏔️', label: 'A Foundation, Not a Title', labelAr: 'أساس لا لقب',
        ...
        didYouKnow: 'Even those who would later become his fiercest enemies never questioned his honesty. The title Al-Amin was not given by his own clan alone but by consensus of the entire city, including families who would one day wage war against his message.',
        didYouKnowAr: 'حتى أشد من سيصبحون أعداءه لاحقاً لم يشككوا قط في أمانته. فلقب الأمين لم يمنحه بنو هاشم وحدهم بل أجمعت عليه مكة كلها، بما فيها عائلات ستحارب رسالته يوماً.'),
    ],
  ...
  'j_m1_011': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'the_return', x: 0.22, y: 0.42, icon: '📦', label: 'The Return', labelAr: 'العودة',
        ...
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Ibn Hisham | Al-Raheeq Al-Makhtum, Ch. 6', sourceRefAr: 'ابن هشام | الرحيق المختوم، الفصل 6',
        didYouKnow: 'Khadijah was the most successful merchant in Mecca and had turned down marriage proposals from the most powerful men of Quraysh. She chose Muhammad \uFDFA, a man with no wealth to speak of, because she valued character above status.',
        didYouKnowAr: 'كانت خديجة أنجح تاجرة في مكة وقد رفضت عروض زواج من أقوى رجال قريش. اختارت محمداً \uFDFA وهو رجل لا مال له يُذكر، لأنها قدّرت الخُلق فوق المكانة.'),
  ...
  // ── Event 13: Solitude in Cave Hira (j_1_2_6) — Pattern F (clustered) ────
  'j_1_2_6': SceneConfig(
    hubLayers: _meccaHubLayers,
    groundLayers: const [],
    hotspots: const [
      SceneHotspot(
        ...
        x: 0.50, y: 0.58,
        icon: '⛰️',
        label: 'The Mountain of Light',
        labelAr: 'جبل النور',
        fragment: 'Jabal al-Nour rises sharply outside Mecca, its rocky face turning golden in the late afternoon sun. Near its summit sits a small cave, barely large enough for a man to lie down. The path leading up is steep and uneven, lined with loose stone and thorny brush. Few people have reason to climb this mountain. But for months now, one man has been making this climb regularly, sometimes staying for days at a time. Muhammad \uFDFA is approaching forty years of age. Something inside him will not rest. The noise of Mecca, its idols and its cruelty, press against a heart that has always known they are wrong.',
        fragmentAr: 'يرتفع جبل النور بحدّة خارج مكة، ووجهه الصخري يتحوّل إلى الذهبي في شمس العصر. قرب قمته يقع كهف صغير لا يكاد يتسع لرجل يستلقي فيه. الممر المؤدي إليه شديد الانحدار وغير مستوٍ، تصطف على جانبيه الحجارة المتساقطة والأشواك. قلّة من الناس لديهم سبب لتسلق هذا الجبل. لكن منذ أشهر ورجلٌ واحد يصعد إليه بانتظام، ويبقى أحيانًا أيامًا كاملة. محمد \uFDFA يقترب من الأربعين. شيءٌ في داخله لا يهدأ. ضجيج مكة وأصنامها وقسوتها تضغط على قلبٍ عرف دائمًا أنها خطأ.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari, Hadith 3 | Ibn Hisham, Vol. 1 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري، حديث 3 | ابن هشام، المجلد 1 | الرحيق المختوم، الفصل 7',
        didYouKnow: 'Cave Hira is located on the summit of Jabal al-Nour, about 3.2 kilometers from the Ka\'bah. The cave is roughly four arm-lengths long and one and a half arm-lengths wide, just enough space for one person in deep solitude.',
        didYouKnowAr: 'يقع غار حراء على قمة جبل النور، على بعد نحو 3.2 كيلومتر من الكعبة. طول الغار نحو أربعة أذرع وعرضه ذراع ونصف تقريبًا، مساحة تكفي لشخص واحد في خلوة عميقة.',
      ),
      SceneHotspot(
        id: 'provisions',
        x: 0.30, y: 0.45,
        icon: '🫗',
        label: 'The Provisions',
        labelAr: 'الزاد',
        fragment: 'Every few days, a figure climbs the rocky path carrying food and water. Khadijah sends provisions to her husband without complaint and without question. She does not ask him why he leaves his home and his trade to sit alone in a cave on a mountain. She does not tell him that his behavior worries her or that the people might talk. She understands something that others cannot see. Whatever is happening to him in that silence is real, and her role is to sustain him through it. She packs the food herself, wraps the water, and sends it up the mountain with steady hands and a trusting heart.',
        fragmentAr: 'كل بضعة أيام يصعد شخصٌ الممر الصخري حاملًا طعامًا وماءً. خديجة ترسل الزاد إلى زوجها دون شكوى ودون سؤال. لا تسأله لماذا يترك بيته وتجارته ليجلس وحيدًا في كهف على جبل. لا تخبره أن سلوكه يقلقها أو أن الناس قد يتحدثون. تفهم شيئًا لا يراه الآخرون. مهما كان ما يحدث له في ذلك الصمت فهو حقيقي، ودورها أن تسنده خلاله. تُعدّ الطعام بنفسها، وتلفّ الماء، وترسله إلى أعلى الجبل بيدين ثابتتين وقلب مطمئن.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari, Hadith 3 | Sahih Muslim, Hadith 160 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري، حديث 3 | صحيح مسلم، حديث 160 | الرحيق المختوم، الفصل 7',
        didYouKnow: 'Khadijah was approximately fifty-five years old during these retreats. Despite her age and status as one of the wealthiest women in Mecca, she personally ensured that her husband never went without provision during his long stays in the cave.',
        didYouKnowAr: 'كانت خديجة في نحو الخامسة والخمسين من عمرها أثناء هذه الخلوات. ورغم سنّها ومكانتها كواحدة من أغنى نساء مكة، حرصت شخصيًا على ألّا ينقطع عن زوجها الزاد خلال إقاماته الطويلة في الغار.',
      ),
      SceneHotspot(
        id: 'tahannuth',
        x: 0.70, y: 0.45,
        ...
        label: 'Al-Tahannuth',
        labelAr: 'التحنّث',
        fragment: 'The Arabs had a word for what he was doing. They called it al-tahannuth, a withdrawal from the world to reflect and seek truth. It was not common, but it was known. A handful of men across the generations had done the same, stepping away from the noise of tribal life to sit with their own souls. But what Muhammad \uFDFA was doing went deeper than tradition. He was not performing a ritual. He was searching for something that the idols could not give and that the poets could not name. Night after night he sat in that small cave, looking out at the stars above Mecca, listening to a silence that grew louder with every visit.',
        fragmentAr: 'كان عند العرب كلمة لما يفعله. سمّوه التحنّث، انسحابٌ من العالم للتأمل والبحث عن الحقيقة. لم يكن شائعًا لكنه كان معروفًا. حفنة من الرجال عبر الأجيال فعلوا الشيء نفسه، ابتعدوا عن ضجيج الحياة القبلية ليجلسوا مع أنفسهم. لكنّ ما كان يفعله محمد \uFDFA أعمق من العادة. لم يكن يؤدي طقسًا بل كان يبحث عن شيء لا تستطيع الأصنام تقديمه ولا يستطيع الشعراء تسميته. ليلة بعد ليلة جلس في ذلك الكهف الصغير، يتأمل النجوم فوق مكة، يصغي إلى صمتٍ يزداد صخبًا مع كل زيارة.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari, Hadith 3 | Ibn Hisham, Vol. 1 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري، حديث 3 | ابن هشام، المجلد 1 | الرحيق المختوم، الفصل 7',
        didYouKnow: 'The Hunafa\', those who rejected idol worship before Islam, also practiced forms of solitary retreat. Among them was Waraqah ibn Nawfal, Khadijah\'s cousin, who would later be the first person to identify the angel that visited the cave.',
        didYouKnowAr: 'الحنفاء الذين رفضوا عبادة الأصنام قبل الإسلام مارسوا أيضًا أشكالًا من الخلوة. من بينهم ورقة بن نوفل، ابن عم خديجة، الذي سيكون أول من يتعرف على الملاك الذي زار الغار.',
      ),
      SceneHotspot(
        id: 'cave_view',
        x: 0.50, y: 0.32,
        icon: '👁️',
        label: 'The View from the Cave',
        labelAr: 'المنظر من الغار',
        fragment: 'From the mouth of the cave, the Ka\'bah is visible far below, a small square structure surrounded by the rooftops of Mecca. Around it, 360 idols stand like silent sentries. The man in the cave has never bowed to a single one of them. He has traded honestly, married faithfully, cared for orphans, and kept every promise he has ever made. And still something is missing. The world below carries on with its buying and selling, its tribal pride and its petty cruelties. Up here, in the silence of the mountain, something is being prepared that will change everything. He does not know that the next time he climbs this path, he will not come down the same man.',
        fragmentAr: 'من فم الغار تظهر الكعبة بعيدة في الأسفل، بناءٌ مربع صغير تحيط به أسطح مكة. حولها تقف 360 صنمًا كحراس صامتين. الرجل في الغار لم يسجد لواحد منها قط. تاجر بأمانة وتزوج بإخلاص ورعى اليتامى وأوفى بكل وعد قطعه. ومع ذلك ثمة شيء ناقص. العالم في الأسفل يستمر ببيعه وشرائه وعصبيته القبلية وقسوته الصغيرة. هنا في الأعلى في صمت الجبل، شيءٌ يُعدّ سيغيّر كل شيء. لا يعلم أن المرة القادمة التي يصعد فيها هذا الممر لن ينزل منه الرجل نفسه.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari, Hadith 3 | Ibn Hisham, Vol. 1 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري، حديث 3 | ابن هشام، المجلد 1 | الرحيق المختوم، الفصل 7',
        didYouKnow: 'The Prophet \uFDFA began seeing true dreams before the revelation came. Every dream he saw would come true like the break of dawn, clear and unmistakable. This period of true dreams lasted approximately six months before Jibril first appeared in the cave.',
        didYouKnowAr: 'بدأ النبي \uFDFA يرى الرؤيا الصادقة قبل نزول الوحي. كل رؤيا يراها تتحقق مثل فلق الصبح، واضحة لا لبس فيها. واستمرت فترة الرؤيا الصادقة نحو ستة أشهر قبل أن يظهر جبريل في الغار لأول مرة.',
      ),
    ],
    // Pattern F — clustered: mountain base → provisions left → tahannuth right → cave view top
    pathWaypoints: const [Offset(0.50, 0.78), Offset(0.50, 0.68), Offset(0.50, 0.58), Offset(0.40, 0.52), Offset(0.30, 0.45), Offset(0.50, 0.45), Offset(0.70, 0.45), Offset(0.60, 0.38), Offset(0.50, 0.32)],
    skyGradient: const [Color(0xFF000000), Color(0xFF000000)],
    particleType: ParticleType.dust, particleCount: 20, particleColor: const Color(0x40C9A84C), showGrain: true,
  ),

  // ── Event 14: The First Revelation (610 CE) ─────────────────────────────
  'j_1_2_7': SceneConfig(
    hubLayers: _meccaHubLayers,
    groundLayers: const [],
    hotspots: const [
      SceneHotspot(id: 'night_ramadan', x: 0.22, y: 0.52, icon: '🌙', label: 'The Night of Ramadan', labelAr: 'ليلة في رمضان',
        fragment: 'It is the month of Ramadan in the year 610 CE. Muhammad \uFDFA is forty years old. For years he has been coming to this cave on the mountain of Hira, spending nights alone in worship and reflection, then returning to Khadijah (may Allah be pleased with her) with food and provisions before going back again. Tonight is no different from any other night. He is alone in the silence of the mountain, with nothing but the stars above Mecca and the stillness of the desert. He does not know that this is the night that will divide all of human history into before and after.',
        fragmentAr: 'إنه شهر رمضان من عام ٦١٠ ميلادي ومحمد \uFDFA في الأربعين من عمره. منذ سنوات وهو يأتي إلى هذا الغار في جبل حراء يقضي الليالي وحده في العبادة والتأمل ثم يعود إلى خديجة رضي الله عنها بالطعام والزاد قبل أن يرجع مرة أخرى. هذه الليلة لا تختلف عن أي ليلة أخرى فهو وحده في صمت الجبل ليس معه إلا النجوم فوق مكة وسكون الصحراء. لا يعلم أن هذه هي الليلة التي ستقسم تاريخ البشرية كله إلى ما قبلها وما بعدها.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari 3 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري 3 | الرحيق المختوم، الفصل 7'),
      SceneHotspot(id: 'iqra', x: 0.42, y: 0.46, icon: '💫', label: '"Read!"', labelAr: '"اقرأ!"',
        fragment: 'An angel appears. Not gently and not gradually. Jibreel seizes him and squeezes him so tightly that he feels he cannot bear it, then releases him and says: "Read!" He replies: "I cannot read." The angel squeezes him a second time until he reaches the limit of his endurance, then releases him and says again: "Read!" He answers: "I cannot read." A third time the angel takes him and presses him until the pressure is almost unbearable, then releases him and speaks the words that will change everything.',
        fragmentAr: 'يظهر ملَك لا بلطف ولا بتدرّج. يأخذه جبريل فيضمّه ضمّة شديدة حتى يبلغ منه الجهد ثم يرسله ويقول: "اقرأ!" فيجيب: "ما أنا بقارئ." فيضمّه الملَك مرة ثانية حتى يبلغ منه الجهد ثم يرسله ويقول مرة أخرى: "اقرأ!" فيجيب: "ما أنا بقارئ." وللمرة الثالثة يأخذه ويضمّه حتى يكاد الضغط لا يُحتمل ثم يرسله وينطق بالكلمات التي ستغيّر كل شيء.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari 3 | Sahih Muslim 160 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري 3 | صحيح مسلم 160 | الرحيق المختوم، الفصل 7',
        didYouKnow: 'The Prophet \uFDFA was unlettered. He had never read a book or written a line in his life. The very first command from Allah to all of humanity was not "fight" or "conquer" but "Read!" Knowledge was the foundation before anything else was built.',
        didYouKnowAr: 'كان النبي \uFDFA أمّياً لم يقرأ كتاباً ولم يخطّ سطراً في حياته قط. وأول أمر من الله للبشرية جمعاء لم يكن "قاتلوا" أو "اغزوا" بل كان "اقرأ!" فالعلم كان الأساس قبل أن يُبنى أي شيء آخر.'),
      SceneHotspot(id: 'first_words', x: 0.62, y: 0.40, icon: '✨', label: 'The First Words', labelAr: 'الكلمات الأولى',
        fragment: '"Read! In the name of your Lord who created. Created man from a clinging substance. Read! And your Lord is the Most Generous. Who taught by the pen. Taught man that which he knew not." These are the first five verses of Surah Al-Alaq. The first words of the Quran ever spoken on earth. They did not begin with a command to pray or fast or fight. They began with knowledge: read, learn, know. The pen. The teaching. The God who created and then taught. From this moment onward, revelation will continue for twenty-three years until the message is complete and the world is transformed.',
        fragmentAr: '"اقْرَأْ بِاسْمِ رَبِّكَ الَّذِي خَلَقَ. خَلَقَ الْإِنْسَانَ مِنْ عَلَقٍ. اقْرَأْ وَرَبُّكَ الْأَكْرَمُ. الَّذِي عَلَّمَ بِالْقَلَمِ. عَلَّمَ الْإِنْسَانَ مَا لَمْ يَعْلَمْ." هذه أول خمس آيات من سورة العلق وأول كلمات القرآن نُطقت على وجه الأرض. لم تبدأ بأمر بالصلاة أو الصيام أو القتال بل بدأت بالعلم: اقرأ وتعلّم واعرف. القلم والتعليم والإله الذي خلق ثم علّم. من هذه اللحظة سيستمر الوحي ثلاثاً وعشرين سنة حتى تكتمل الرسالة ويتحوّل وجه العالم.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
      ...
      SceneHotspot(id: 'cover_me', x: 0.80, y: 0.34, icon: '🫂', label: '"Cover Me, Cover Me"', labelAr: '"زمّلوني، زمّلوني"',
        fragment: 'He comes down the mountain trembling. His heart is racing. He enters upon Khadijah and says: "Cover me, cover me!" She wraps him in a cloak until the fear subsides. Then he tells her what happened and says: "I feared for myself." Khadijah does not hesitate. She does not doubt him. She says: "Never! By Allah, Allah will never disgrace you. You keep ties of kinship, you bear the burden of the weak, you earn for the destitute, you honor your guests, and you help those struck by calamity." In the most terrifying moment of his life, the first person to steady him is his wife. The first person to believe is the one who knew him best.',
        fragmentAr: 'ينزل من الجبل يرتجف وقلبه يخفق فيدخل على خديجة ويقول: "زمّلوني زمّلوني!" فتلفّه في ثوب حتى يذهب عنه الروع. ثم يخبرها بما حدث ويقول: "لقد خشيت على نفسي." فلا تتردد خديجة ولا تشكّ فيه بل تقول: "كلا والله لا يخزيك الله أبداً. إنك لتصل الرحم وتحمل الكلّ وتكسب المعدوم وتقري الضيف وتعين على نوائب الحق." في أشد لحظات حياته رعباً أول من يثبّته زوجته وأول من يؤمن به من يعرفه أكثر من أي إنسان آخر.',
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Sahih Bukhari 3 | Al-Raheeq Al-Makhtum, Ch. 7',
        sourceRefAr: 'صحيح البخاري 3 | الرحيق المختوم، الفصل 7',
        didYouKnow: 'Khadijah then took him to her cousin Waraqah ibn Nawfal, an elderly Christian scholar who had knowledge of the scriptures. When Waraqah heard what happened, he said: "This is the same angel who came to Musa. I wish I were young enough to be alive when your people will drive you out." The Prophet \uFDFA was astonished and asked: "Will they drive me out?" Waraqah replied: "No man has ever brought what you bring without being met with hostility."',
        didYouKnowAr: 'ثم أخذته خديجة إلى ابن عمها ورقة بن نوفل وكان شيخاً مسيحياً عالماً بالكتب المقدسة. فلما سمع ورقة ما حدث قال: "هذا الناموس الذي أُنزل على موسى. يا ليتني أكون حياً إذ يخرجك قومك." فتعجّب النبي \uFDFA وسأل: "أوَمخرجيّ هم؟" فأجاب ورقة: "لم يأتِ رجل قط بمثل ما جئت به إلا عُودي."'),
    ],
    // Pattern B — left to right
    pathWaypoints: const [Offset(0.12, 0.58), Offset(0.17, 0.55), Offset(0.22, 0.52), Offset(0.32, 0.49), Offset(0.42, 0.46), Offset(0.52, 0.43), Offset(0.62, 0.40), Offset(0.72, 0.37), Offset(0.80, 0.34)],
    skyGradient: const [Color(0xFF000000), Color(0xFF000000)],
