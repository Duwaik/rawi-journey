  ...
  'j_1_2_3': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'road_north', x: 0.42, y: 0.46, icon: '🐪', label: 'The Road North', labelAr: 'الطريق شمالاً',
        ...
        didYouKnow: 'This journey to Syria was the first time Muhammad \uFDFA traveled beyond the Arabian Peninsula. Along the way, a Christian monk named Bahira in Bosra recognized signs of prophethood in the boy and warned Abu Talib to guard him carefully from those who might wish him harm.',
        didYouKnowAr: 'كانت هذه الرحلة إلى الشام المرة الأولى التي يسافر فيها محمد \uFDFA خارج الجزيرة العربية. وفي الطريق تعرّف راهب مسيحي يُدعى بحيرى في بُصرى على علامات النبوة في الصبي وحذّر أبا طالب أن يحرسه جيداً ممن قد يريدون به سوءاً.'),
