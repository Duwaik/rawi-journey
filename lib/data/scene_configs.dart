  ...
  'j_m1_010': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'foundation', x: 0.50, y: 0.28, icon: '🏔️', label: 'A Foundation, Not a Title', labelAr: 'أساس لا لقب',
        ...
        didYouKnowAr: 'لحظة جبل الصفا حدثت بعد سنوات من نزول الوحي عليه، لكنها نجحت فقط بسبب عقود من الثقة بُنيت معاملة تلو معاملة. حين سألهم "أكنتم مصدّقيّ؟" أجاب الجمع كله بنعم. تلك النعم الواحدة كانت ثمرة عمر كامل من النزاهة.'),
    ],
  ...
  'j_m1_011': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'the_return', x: 0.22, y: 0.42, icon: '📦', label: 'The Return', labelAr: 'العودة',
        ...
        sfxPath: 'assets/audio/sfx_kaabah_wind.wav',
        sourceRef: 'Ibn Hisham | Al-Raheeq Al-Makhtum, Ch. 6', sourceRefAr: 'ابن هشام | الرحيق المختوم، الفصل 6',
        didYouKnow: 'Khadijah sent her servant Maysara to observe Muhammad \uFDFA during the trade journey to Syria. Maysara returned astonished by his honesty and the blessings that accompanied him. His report convinced Khadijah that this was no ordinary man.',
        didYouKnowAr: 'أرسلت خديجة خادمها ميسرة ليراقب محمداً \uFDFA خلال رحلة التجارة إلى الشام. عاد ميسرة مندهشاً من أمانته والبركات التي رافقته. تقريره أقنع خديجة أن هذا ليس رجلاً عادياً.'),
