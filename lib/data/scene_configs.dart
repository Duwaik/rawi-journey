  ...
  'j_m1_010': SceneConfig(
    ...
    hotspots: const [
      ...
      SceneHotspot(id: 'keeper_trusts', x: 0.25, y: 0.44, icon: '🔒', label: 'Keeper of Trusts', labelAr: 'حافظ الأمانات',
        ...
        didYouKnowAr: 'حين هاجر النبي \uFDFA إلى المدينة طلب من عليّ بن أبي طالب أن يبقى في مكة خصيصاً لإعادة الأمانات التي أودعها الناس عنده، فحتى وهم يتآمرون لقتله كانت ممتلكاتهم لا تزال آمنة في بيته.'),
